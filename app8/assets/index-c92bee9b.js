...
const _hoisted_17 = /* @__PURE__ */ createStaticVNode('<div class="form-floating mb-2"><label for="email">Email</label> <br><input class="form-control" type="email" id="email" placeholder="example@email.com" size="30" required></div><div class="form-floating mb-2"><label for="phone">Phone number</label> <br><input class="form-control" type="tel" id="phone" name="phone" placeholder="123-456-7890" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" required></div>', 2);
const _hoisted_19 = { class: "form-floating mb-2" };
const _hoisted_20 = /* @__PURE__ */ createBaseVNode("label", {
  for: "avatar",
  class: "form-label"
}, "Profile picture (optional):", -1);
...
const _hoisted_24 = { id: "fig1" };
const _hoisted_25 = /* @__PURE__ */ createBaseVNode("img", { id: "preview-img" }, null, -1);
          ...
          createBaseVNode("fieldset", _hoisted_3, [
            ...
            createBaseVNode("div", _hoisted_22, [
              createBaseVNode("div", _hoisted_23, [
                createBaseVNode("figure", _hoisted_24, [
                  _hoisted_25,
